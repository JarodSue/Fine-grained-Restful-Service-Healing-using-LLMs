...
import org.testng.annotations.Test;
import java.util.concurrent.TimeUnit;
public class testnumber38for1083Tests extends TestNGCitrusSpringSupport{
    @CitrusResource
...
private static final Logger log = Logger.getLogger("autoGeneratedTests");
       ...
       .respond(
                      ...
                      new Header("Authorization", "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiI5IiwiaWQiOjksImV4cCI6MTcyNTk3NjQ2NSwiaWF0IjoxNzI1ODkwMDY1fQ.sCtro_z7zW63-9HHDijYFpDPsCpS4xSJ85WvuNRKoV509HB4eRVUdxxN90fEABFX7MDSVAn7cUl3NCmyXc5diA"))
               ...
               mockServer.when(
                    request()
                      ...
                      .withHeader("Authorization", "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiI5IiwiaWQiOjksImV4cCI6MTcyNTk3NjQ2NSwiaWF0IjoxNzI1ODkwMDY1fQ.sCtro_z7zW63-9HHDijYFpDPsCpS4xSJ85WvuNRKoV509HB4eRVUdxxN90fEABFX7MDSVAn7cUl3NCmyXc5diA")          ,Times.exactly(1))
       .respond(
                          response()
                            .withStatusCode(200)
                            .withBody("")
    ...
    public void testAlgo1() throws FileNotFoundException, InterruptedException{
          ...
          String status="";
                ...
                if ((status.equals("400"))){assertTrue(true);}
        ...
        mockServer.verify(
         ...
         mockServer.verify(
                        request().withPath("/prod/Products"),
                        VerificationTimes.exactly(1)
        ); 
         mockServer.verify(
