...
import org.testng.annotations.Test;
import java.util.concurrent.TimeUnit;
public class testnumber37for1083Tests extends TestNGCitrusSpringSupport{
    @CitrusResource
           ...
           mockServer = startClientAndServer(1080);
               ...
               mockServer.when(
                    request()
                      ...
                      .withHeader("Authorization", "Bearer eJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJjYW5hcmQiLCJpZCI6MywiZXhwIjoxNzI1OTY4MTUwLCJpYXQiOjE3MjU4ODE3NTB9.XfHzAXpozoGqQgzWLegHXK0IUVKxxZ6-8Wl6NtKIBwnzDwhhBV59GIzPltr-cBJ8og8hP46C79DBUhwWQbEswQ")          ,Times.exactly(1))
       .respond(
                          response()
                            .withStatusCode(500)
                            .withBody("")
          ...
          String status="";
                            ...
                            $(http()
                                ...
                                .body("{\"name\":\"ProduitTest\",\"cost\":\"80\",\"stock\":\"100\"}")
                                   .header("Authorization", "Bearer eJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJjYW5hcmQiLCJpZCI6MywiZXhwIjoxNzI1OTY4MTUwLCJpYXQiOjE3MjU4ODE3NTB9.XfHzAXpozoGqQgzWLegHXK0IUVKxxZ6-8Wl6NtKIBwnzDwhhBV59GIzPltr-cBJ8og8hP46C79DBUhwWQbEswQ")
