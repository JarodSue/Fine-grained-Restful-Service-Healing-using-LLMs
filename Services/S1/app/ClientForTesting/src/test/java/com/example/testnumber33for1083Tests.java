...
import org.testng.annotations.Test;
import java.util.concurrent.TimeUnit;
public class testnumber33for1083Tests extends TestNGCitrusSpringSupport{
    @CitrusResource
           ...
           mockServer = startClientAndServer(1080);
               ...
               mockServer.when(
                    request()
                      ...
                      .withHeader("Authorization", "Bearer yJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJjYW5hcmQiLCJpZCI6MywiZXhwIjoxNzI1OTY4MTUwLCJpYXQiOjE3MjU4ODE3NTB9.XfHzAXpozoGqQgzWLegHXK0IUVKxxZ6-8Wl6NtKIBwnzDwhhBV59GIzPltr-cBJ8og8hP46C79DBUhwWQbEsw")          ,Times.exactly(1))
       .respond(
                          response()
                            .withStatusCode(500)
                            .withBody("")
    ...
    public void testAlgo1() throws FileNotFoundException, InterruptedException{
          ...
          String status="";
                            ...
                            $(http()
                                ...
                                .message()
                                   .header("Authorization", "Bearer yJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJjYW5hcmQiLCJpZCI6MywiZXhwIjoxNzI1OTY4MTUwLCJpYXQiOjE3MjU4ODE3NTB9.XfHzAXpozoGqQgzWLegHXK0IUVKxxZ6-8Wl6NtKIBwnzDwhhBV59GIzPltr-cBJ8og8hP46C79DBUhwWQbEsw")
