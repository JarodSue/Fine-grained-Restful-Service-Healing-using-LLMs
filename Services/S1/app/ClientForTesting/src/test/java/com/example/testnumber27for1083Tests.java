...
import org.testng.annotations.Test;
import java.util.concurrent.TimeUnit;
public class testnumber27for1083Tests extends TestNGCitrusSpringSupport{
    @CitrusResource
...
private static final Logger log = Logger.getLogger("autoGeneratedTests");
       ...
       .respond(
                      ...
                      new Header("Authorization", "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiI3IiwiaWQiOjcsImV4cCI6MTcyNTk3NjI4NCwiaWF0IjoxNzI1ODg5ODg0fQ.PMzyTss7lOkRkQlh5VwkY66vIxOAmcAyJEvgBrmf0HaXRsom2AaoZoeVbB-hPeX8Sw1Etj9BCuuGiQeb6uxi2g"))
               ...
               mockServer.when(
                    request()
                      ...
                      .withHeader("Authorization", "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiI3IiwiaWQiOjcsImV4cCI6MTcyNTk3NjI4NCwiaWF0IjoxNzI1ODg5ODg0fQ.PMzyTss7lOkRkQlh5VwkY66vIxOAmcAyJEvgBrmf0HaXRsom2AaoZoeVbB-hPeX8Sw1Etj9BCuuGiQeb6uxi2g")          ,Times.exactly(1))
       .respond(
                          response()
                            .withStatusCode(200)
                            .withBody("")
    ...
    public void testAlgo1() throws FileNotFoundException, InterruptedException{
          ...
          String status="";
                ...
                if ((status.equals("200")) && (token.equals("Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiI3IiwiaWQiOjcsImV4cCI6MTcyNTk3NjI4NCwiaWF0IjoxNzI1ODg5ODg0fQ.PMzyTss7lOkRkQlh5VwkY66vIxOAmcAyJEvgBrmf0HaXRsom2AaoZoeVbB-hPeX8Sw1Etj9BCuuGiQeb6uxi2g"))){assertTrue(true);}
