...
import org.testng.annotations.Test;
import java.util.concurrent.TimeUnit;
public class VERB_Response_ROUTE__client_Products_9_OPERATOR_TokenTests extends TestNGCitrusSpringSupport{
    @CitrusResource
...
private static final Logger log = Logger.getLogger("autoGeneratedTests");
    ...
    public void testAlgo1() throws FileNotFoundException, InterruptedException{
        ...
        mockServer.verify(
         ...
         mockServer.verify(
                        request().withPath("/prod/Products/9"),
                        VerificationTimes.exactly(1)
        ); 
            }
