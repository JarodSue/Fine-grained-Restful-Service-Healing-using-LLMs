...
import org.testng.annotations.Test;
public class testNumber9ForPCO8080Tests extends TestNGCitrusSpringSupport{
    @CitrusResource
...
private static final Logger log = Logger.getLogger("autoGeneratedTests");
    ...
    public void testAlgo1() throws FileNotFoundException{
                            ...
                            $(receive(toClient)
                                ...
                                .type(MessageType.PLAINTEXT)
                                .name("Response")
                                    .header(HttpMessageHeaders.HTTP_STATUS_CODE, 404)
);        
...
@Test(groups = "b",dependsOnGroups = "a")
    ...
    public static void Yreste() throws InterruptedException{
        ...
        mockServer.verify(
                        ...
                        VerificationTimes.exactly(9)
        ); 
        mockServer.verify(
                        request().withPath("/pay/Card/200/1"),
