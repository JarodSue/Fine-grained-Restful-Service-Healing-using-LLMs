...
import org.testng.annotations.Test;
import java.util.concurrent.TimeUnit;
public class testnumber28for1084Tests extends TestNGCitrusSpringSupport{
    @CitrusResource
    ...
    public void testAlgo1() throws FileNotFoundException, InterruptedException{
          ...
          String status="";
                            ...
                            $(http()
                                ...
                                .message()
                                   .header("Authorization", "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiI4IiwiaWQiOjgsImV4cCI6MTcyNTk3NjM0NywiaWF0IjoxNzI1ODg5OTQ3fQ.jeWlxKLrmZzVqCjghCsdm79ila169z8hGReiu1qC9P_KJan5zpaX9-wGoesDxvYmAgX2o9nPqw9CymrUYOZGIA")
